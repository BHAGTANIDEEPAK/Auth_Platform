...
(function () {
  ...
  // Create a wrapper for blocking the main UI and showing the loader
  ...
  overlay.style.zIndex = '10000'; // Ensure the overlay is above other content
